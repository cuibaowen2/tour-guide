...
public class PermissionsUtil {
    ...
    /**
     * 申请授权，当用户拒绝是，会显示默认一个默认的Dialog提示用户
     *
     * @param context    上下文
     * @param listener   权限监听
    ...
    /**
     * 申请权限，当用户拒绝时，可以设置是否显示Dialog提示用户，也可以设置提示用户的文本内容
     *
     * @param context
     * @param listener
    ...
    public static class TipInfo implements Serializable {
        ...
        public TipInfo(@NonNull String title, @NonNull String content, @NonNull String cancel, @NonNull String ensure) {
            this.title = title;
